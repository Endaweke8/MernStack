     ...
     <table class="min-w-full">
         <thead>
             <tr>
                 ...
                 <th class="px-6 py-3 bg-gray-50 border-b border-gray-200 text-gray-600 text-left text-sm uppercase font-normal">Age</th>
         ...
         <tbody>
           {users.map((user,index)=>{
            return (
                ...
                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">{user.age}</td>
